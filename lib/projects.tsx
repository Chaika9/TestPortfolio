...
export const projects: ProjectType[] = [
    {
        name: "Onigami",
        description:
            "<img src='/TestPortfolio/project/onigami/image1.png' alt='Image1' />"
            ...
            + "</br> - User Watchlist",
        coverImage: "/TestPortfolio/project/onigami/image1.png",
        tags: ["Web", "API", "Next.js", "TailwindCSS", "GraphQL"],
    },
    {
        name: "Paladium Bedrock",
        description:
            "<img src='/TestPortfolio/project/paladium/banner.png' width='500' alt='Banner' />"
            + "<h1 class='mt-5 text-2xl font-bold'>Introduction</h1>"
            + "</br>Paladium Bedrock is a port of the Paladium Java Editionto Minecraft Bedrock Edition.",
        coverImage: "/TestPortfolio/project/paladium/image1.png",
    ...
    },
    {
        name: "Sephira OS",
        description:
            "<img src='/TestPortfolio/project/sephiraos/image1.png' alt='Image1' />"
            + "<h1 class='mt-5 text-2xl font-bold'>Introduction</h1>"
        ...
        coverImage: "/TestPortfolio/project/sephiraos/image1.png",
        tags: ["Operating System", "Software"],
    },
    {
        name: "Minecraft Unity",
        description:
            "<img src='/TestPortfolio/project/minecraft/image1.png' alt='Image1' />"
            + "<h1 class='mt-5 text-2xl font-bold'>Introduction</h1>"
        ...
        coverImage: "/TestPortfolio/project/minecraft/image1.png",
